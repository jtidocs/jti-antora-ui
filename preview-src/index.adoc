...
[.tablecontainer]
--
[cols="2a,a,a,a,a,a,a", options="header", role="uith"]
|===
| Property
| [.ui.ui-field]``New Case forms``
| [.ui.ui-field]``Header forms``
| [.ui.ui-field]``Folder Views``
| [.ui.ui-field]``Add forms``
| [.ui.ui-field]``Update forms``
| [.ui.ui-field]``Searches``

| [.ui.ui-field]``Conditions``
| {x}
| {x}
| {x}
| {x}
...
| `Conditions`
| Use the `Conditions` dropdown to filter the items to show.

This condition is more powerful than a simple condition.
For example, you can show only records where the case is `Disposed` and jury fees are posted.
|===
